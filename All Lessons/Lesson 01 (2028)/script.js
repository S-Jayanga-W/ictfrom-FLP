...
// The episode list itself now lives in "data.js" (loaded before this
// file in index.html) as the single source of truth — Home.html's
// site-wide search reads the SAME data.js file, so editing an episode
// here means editing it ONLY in data.js. Never re-add episodes below.
const episodes = window.CURRENT_LESSON.episodes;
